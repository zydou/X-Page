 ...
 *       div.tweet-author > a
 *       div.tweet-time
 *     a.refresh-btn（可选，使用 margin-left: auto 靠右）
 *
 ...
 * @param {string} [refreshUrl] 可选，刷新链接 URL；提供时在头部右侧渲染刷新按钮
 * @returns {string} 可直接嵌入推文卡片的 HTML 片段
 */
export function authorTag(author, tweetUrl, dateStr, avatarUrl, refreshUrl) {
  const refreshBtn = refreshUrl
    ? `<a href="${refreshUrl}" class="refresh-btn" title="强制刷新（绕过缓存）">
    <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      <path d="M3 10a7 7 0 0 1 12-4.9M17 10a7 7 0 0 1-12 4.9"/>
